...
impl ValuationMethod {
    ...
    pub fn label(&self) -> &'static str {
        match self {
            ...
            ValuationMethod::MovingAverage => "میانگین متحرک",
            ValuationMethod::WeightedAverage => "میانگین موزون",
        }
    }

    /// توضیح ساده برای کاربری که حسابداری نمی‌داند.
    pub fn plain_explanation(&self) -> &'static str {
        match self {
            ValuationMethod::Fifo => concat!(
                "کالایی که زودتر خریده‌اید، زودتر هم فروخته می‌شود. ",
                "پس بهای فروش از قدیمی‌ترین خرید برداشته می‌شود و آنچه در انبار ",
                "می‌ماند با قیمت خریدهای جدیدتر ارزش‌گذاری می‌گردد. ",
                "مناسب کالای تاریخ‌دار و بازاری که قیمت‌ها بالا می‌رود."
            ),
            ValuationMethod::MovingAverage => concat!(
                "با هر خرید جدید، میانگین قیمت کالا دوباره حساب می‌شود. ",
                "همه‌ی فروش‌های بعدی با همان میانگین ثبت می‌شوند. ",
                "سود و زیان یکنواخت‌تر می‌شود و نوسان قیمت خرید کمتر به چشم می‌آید. ",
                "مناسب کالایی که مرتب و با قیمت‌های مختلف خریده می‌شود."
            ),
            ValuationMethod::WeightedAverage => concat!(
                "میانگین قیمت کل خریدهای یک دوره محاسبه و برای همه‌ی فروش‌های آن ",
                "دوره استفاده می‌شود. ساده‌ترین روش برای گزارش‌گیری دوره‌ای است. ",
                "مناسب کالای انبوه و یکسان مثل مواد اولیه فله."
            ),
        }
    }
}
