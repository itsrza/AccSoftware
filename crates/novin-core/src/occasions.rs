...
pub const OCCASIONS: &[Occasion] = &[
    // ------------------------------------------------------------- شمسی
    Occasion { calendar: "jalali", month: 1, day: 1, title: "نوروز", holiday: true },
    Occasion { calendar: "jalali", month: 1, day: 2, title: "عید نوروز", holiday: true },
    Occasion { calendar: "jalali", month: 1, day: 3, title: "عید نوروز", holiday: true },
    Occasion { calendar: "jalali", month: 1, day: 4, title: "عید نوروز", holiday: true },
    Occasion { calendar: "jalali", month: 1, day: 12, title: "روز جمهوری اسلامی", holiday: true },
    Occasion { calendar: "jalali", month: 1, day: 13, title: "سیزده‌بدر", holiday: true },
    Occasion { calendar: "jalali", month: 3, day: 14, title: "رحلت امام خمینی", holiday: true },
    Occasion { calendar: "jalali", month: 3, day: 15, title: "قیام ۱۵ خرداد", holiday: true },
    Occasion { calendar: "jalali", month: 11, day: 22, title: "پیروزی انقلاب اسلامی", holiday: true },
    Occasion { calendar: "jalali", month: 12, day: 29, title: "روز ملی شدن صنعت نفت", holiday: true },
    // -------------------------------------------------------------- قمری
    Occasion { calendar: "hijri", month: 1, day: 9, title: "تاسوعای حسینی", holiday: true },
    Occasion { calendar: "hijri", month: 1, day: 10, title: "عاشورای حسینی", holiday: true },
    Occasion { calendar: "hijri", month: 2, day: 20, title: "اربعین حسینی", holiday: true },
    Occasion { calendar: "hijri", month: 2, day: 28, title: "رحلت رسول اکرم (ص) و شهادت امام حسن مجتبی (ع)", holiday: true },
    Occasion { calendar: "hijri", month: 2, day: 30, title: "شهادت امام جعفر صادق (ع)", holiday: true },
    Occasion { calendar: "hijri", month: 3, day: 8, title: "شهادت امام حسن عسکری (ع)", holiday: false },
    Occasion { calendar: "hijri", month: 3, day: 17, title: "میلاد رسول اکرم (ص) و امام جعفر صادق (ع)", holiday: true },
    Occasion { calendar: "hijri", month: 6, day: 3, title: "شهادت حضرت فاطمه زهرا (س)", holiday: false },
    Occasion { calendar: "hijri", month: 7, day: 13, title: "ولادت امام علی (ع)", holiday: false },
    Occasion { calendar: "hijri", month: 7, day: 27, title: "مبعث رسول اکرم (ص)", holiday: true },
    Occasion { calendar: "hijri", month: 8, day: 15, title: "ولادت حضرت قائم (عج)", holiday: true },
    Occasion { calendar: "hijri", month: 9, day: 21, title: "شهادت امام علی (ع)", holiday: true },
    Occasion { calendar: "hijri", month: 10, day: 1, title: "عید سعید فطر", holiday: true },
    Occasion { calendar: "hijri", month: 10, day: 2, title: "تعطیل به مناسبت عید سعید فطر", holiday: true },
    Occasion { calendar: "hijri", month: 12, day: 10, title: "عید سعید قربان", holiday: true },
    Occasion { calendar: "hijri", month: 12, day: 18, title: "عید سعید غدیر خم", holiday: false },
];
...
pub fn occasions_between(from: NaiveDate, to: NaiveDate) -> Result<Vec<OccasionDay>, OccasionError> {
    if to < from {
