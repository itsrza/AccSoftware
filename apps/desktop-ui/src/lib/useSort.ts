/**
 * مرتب‌سازی مشترک جدول‌ها.
 *
 * یک پیاده‌سازی برای همه‌ی صفحات، تا رفتار مرتب‌سازی (جهت، نوع مقایسه،
 * نشانگر ستون) در سراسر برنامه یکسان بماند و هر صفحه منطق خودش را ننویسد.
 */
