...
export function Production() {
  ...
  // --- فرمول ---
  const [formulaForm, setFormulaForm] = useState<FormulaDraft | null>(null)
  ...
  return (
    <section className="page">
      ...
      <ProductionFormulaDialogs
        formulaForm={formulaForm}
        setFormulaForm={setFormulaForm}
        formulaDetail={formulaDetail}
        setFormulaDetail={setFormulaDetail}
        products={products}
        busy={busy}
        onSave={saveFormula}
      />
